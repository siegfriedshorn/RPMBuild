...
0xFF64,	0x0B0B,	0x4A2D,	0x4B2E,	| NOTHING, Norfair, Cookie Country, Venus Lighthouse 
...
0x5421,	0x5421,	0x5421,	0x5421,	|    #Bowsers_Keep, Bowsers_Keep, Bowsers_Keep, Bowsers_Keep
0x5421,	0x5421,	0x5421	|   #Bowsers_Keep, Bowsers_Keep, Bowsers_Keep
